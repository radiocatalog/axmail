...
#define VERSION "axMail-Fax v1.0.4"
#define COPYRIGHT "(c) 1996, 1998 Heikki Hannikainen (OH7LZB) <hessu@pspt.fi>\nMailbox save support (c) 2003 Marius Petrescu (YO2LOJ) <mpetrescu@online.ro>\nOther modifications (c) 2005, 2006 by Brian Rogers (N1URO) <n1uro@n1uro.com> "
#define PROMPT "=> "
